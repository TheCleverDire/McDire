...
{
    public class CmdGeoIP : Command2
    {
        public override string name { get { return "GeoIP"; } }
        ...
        class GeoInfo
        {
            ...
            [ConfigString] public string hostname;
        }
        ...
        public override void Use(Player p, string message, CommandData data)
        {
            ...
            p.Message("  Country: &f{0}", info.country);
            p.Message("  Region/State: &f{0}", info.region);
            p.Message("  City: &f{0}", info.city);
            p.Message("  Hostname: &f{0}", info.hostname);
